...
await page.locator ('#username') .fill ("parthi@nigsoft.com");
await page.locator ("#password").fill ("Parthi@12");
await page.locator ('#login_btn').click();
await page.waitForLoadState('networkidle');
await expect (page).toHaveURL ("https://niglabs.com/users/dashboard.php");

});
test('Invalid Password', async ({ page }) => {
    await page.goto('https://niglabs.com/index.php');
    await page.fill('#username', 'parthi@nigsoft.com');
  ...
  test('Password Case Sensitivity Check', async ({ page }) => {
    await page.goto('https://niglabs.com/index.php');
    await page.fill('#username', 'PARHTI@nigsoft.com');
    await page.fill('#password', 'PARTHI@12');
    await page.click('#login_btn');
    await expect(page.locator('.error')).toBeVisible();
  });